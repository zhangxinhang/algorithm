...
public class L0010RegularExpressionMatching {
    public static void main(String[] args) {
        ...
        Solution solution = new L0010RegularExpressionMatching().new Solution();
    ...
    class Solution {
        ...
        boolean isMatching(String s, String p, int si, int pj) {
            if (pj == -1) {
                if (si == -1) {
                    return true;
                } else {
            ...
            if (si > -1 && (p.charAt(pj) == '.' || s.charAt(si) == p.charAt(pj))) {
